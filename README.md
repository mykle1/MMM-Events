...
## Config.js entry and options

    {
        ...
        config: {
			...
			eventType: "music",     // Choose from Events List in below
			mode: "noFrame",        // "Frame" or "noFrame" (around picture)
			apikey: "Your FREE API Key Goes Here", // Get FREE API key --> http://eventful.com/join?goto=http%3A%2F%2Fapi.eventful.com%2Fkeys#/
